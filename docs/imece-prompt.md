...
Generated by `imece prompt ali lead-architect --caps "architecture,api"`. Contains: identity block, session start commands (npx @oxog/imece inbox, npx @oxog/imece status), communication reference, file locking protocol, self-introduction broadcast.
